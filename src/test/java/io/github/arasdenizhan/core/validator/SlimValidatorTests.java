...
public class SlimValidatorTests {
    ...
    static class UserDto {
        ...
        public UserDto(String name, Integer age, Integer countryCode, String email, String anotherEmail, String password) {
            this.name = name;
            this.age = age;
    ...
    public void testValidate_Fails_WhenNameIsNull() {
        UserDto user = getUser(null, 25, -1, "email2@test.com", "anotherEmail2@test.com", "password2");
    ...
    public void testValidate_Fails_WhenAgeIsLessThanMin() {
        UserDto user = getUser("Denizhan", 15, -1, "email3@test.com", "anotherEmail3@test.com", "password3");
    ...
    public void testValidate_Fails_WhenCountryCodeIsGreeterThanMax() {
        UserDto user = getUser("Denizhan1", 18, 3, "email4@test.com", "anotherEmail4@test.com", "password4");
    ...
    public void testValidate_Fails_WhenEmailNotFitsPattern() {
        UserDto user = getUser("Denizhan2", 18, 1, "email", "anotherEmail5@test.com", "password5");
    ...
    public void testValidate_Fails_WhenAnotherEmailNotAnEmailString() {
        UserDto user = getUser("Denizhan3", 18, 1, "email5@test.com", "anotherEmail", "password6");
    ...
    public void testValidate_Fails_WhenLengthIsNotGreeterThanMin() {
        UserDto user = getUser("Denizhan4", 18, 1, "email6@test.com", "anotherEmail6@test.com", "pass");
    ...
    public void testValidate_Fails_WhenLengthIsNotLessThanMax() {
        UserDto user = getUser("Denizhan5", 18, 1, "email7@test.com", "anotherEmail7@test.com", "passpasspasspasspasspasspasspass");
    ...
    public void testValidate_Fails_MultipleFields() {
        UserDto user = getUser(null, 13, -1, "email24", "anotherEmail24", "deniz");
    ...
    private static UserDto getUser(String name, Integer age, Integer countryCode, String email, String anotherEmail, String password) {
        return new UserDto(name, age, countryCode, email, anotherEmail, password);
    }
}
